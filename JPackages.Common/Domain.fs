...
module Xml =
    ...
    type Node =
        ...
        member this.HasAttributes = not (this.Attributes |> Map.isEmpty)

        member this.HasChildren = not (this.Children |> List.isEmpty)
        ...
        member this.ToString (?includeHeader : bool) =
            ...
            let attributes =
                ...
                | false ->
                    this.Attributes
                    |> (" "
                        |> Map.fold (fun attributes attributeName attributeValue ->
