...
type Collections () =
    ...
    [<Benchmark>]
    member this.ListAppend () =
        List.append list list2

    [<Benchmark>]
    member this.ArrayAppend () =
        Array.append arr arr2
        
    [<Benchmark>]
    member this.ListPrepend () =
        1001 :: list
        
    [<Benchmark>]
    member this.ArrayPrepend () =
        Array.append [| 1001 |] arr

    [<Benchmark>]
    member this.ListConcat () =
        List.concat [ list; list2; list3 ]
